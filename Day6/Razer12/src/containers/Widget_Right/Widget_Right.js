...
class Widget_Right extends Component {
    ...
    render() {
        ...
        if(this.state.isToggleMicSidetone) {
            sidetone = 
            <div className="switch switch-slider on" id="swSide" onClick={this.handleSideTone}>
                <div className="handle" />
            </div>
        }
        else {
            sidetone =
            <div className="switch switch-slider " id="swSide" onClick={this.handleSideTone}>
                <div className="handle" />
            </div>
        }
        ...
        if(this.state.isActiveSidetone) {
            ...
            <div className="slider-container on" id="slPhone">
                ...
                <div id="slSideFill" className="left" style={{width: (this.state.sidetoneValue * 520) / 100}}></div>
                <div className="track"></div>
                <div id="slSideTip" className="slider-tip" style={{left: (this.state.sidetoneValue * 520) / 100 - 15}}>{this.state.sidetoneValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
        ...
        if(this.state.isShowNorm) {
            ...
            <div className="slider-container on" id="slNorm">
                ...
                <div id="sNormFill" className="left" style={{width: (this.state.normValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slNormTip" className="slider-tip" style={{left: (this.state.normValue * 490) / 100 - 15}}>{this.state.normValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
            ...
            <div className="slider-container" id="slNorm">
                ...
                <div className="foot mid">medium</div>
                <div className="foot max">high</div>
                <div id="slNormFill" className="left" style={{width: (this.state.normValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slNormTip" className="slider-tip" style={{left: (this.state.normValue * 490) / 100 - 15}}>{this.state.normValue}</div>
                <input
                    type="range"
        ...
        if(this.state.isShowAmb) {
            ...
            <div className="slider-container on" id="slAmb">
                ...
                <div className="foot mid">medium</div>
                <div className="foot max">high</div>
                <div id="sAmbFill" className="left" style={{width: (this.state.ambValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slAmbTip" className="slider-tip" style={{left: (this.state.ambValue * 490) / 100 - 15}}>{this.state.ambValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
            ...
            <div className="slider-container" id="slAmb">
                ...
                <div className="foot mid">medium</div>
                <div className="foot max">high</div>
                <div id="sNormFill" className="left" style={{width: (this.state.ambValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slNormTip" className="slider-tip" style={{left: (this.state.ambValue * 490) / 100 - 15}}>{this.state.ambValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
        ...
        if(this.state.isShowVoiceClarity) {
            ...
            <div className="slider-container on" id="slClarity">
                ...
                <div className="foot mid">medium</div>
                <div className="foot max">high</div>
                <div id="sAmbFill" className="left" style={{width: (this.state.voiceClarityValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slAmbTip" className="slider-tip" style={{left: (this.state.voiceClarityValue * 490) / 100 - 15}}>{this.state.voiceClarityValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
            ...
            <div className="slider-container" id="slClarity">
                ...
                <div className="foot mid">medium</div>
                <div className="foot max">high</div>
                <div id="sNormFill" className="left" style={{width: (this.state.voiceClarityValue * 490) / 100}}></div>
                <div className="track"></div>
                <div id="slNormTip" className="slider-tip" style={{left: (this.state.voiceClarityValue * 490) / 100 - 15}}>{this.state.voiceClarityValue}</div>
                <input
                    type="range"
                    min={0}
                    max={100}
            ...
            <div className="widget-col col-right flex">
                ...
                <div className="widget" id="micEnhance">
                    ...
                    <div className="check-item">
                        <input type="checkbox" id="checkNorm" onClick={this.handleActiveNorm}/>
                    ...
                    <div className="check-item">
                        <input type="checkbox" id="checkAmb" onClick={this.handleActiveAmb}/>
                    ...
                    <div className="check-item">
                        <input type="checkbox" id="checkClarity" onClick={this.handleActiveVoiceClarity}/>
