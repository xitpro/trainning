class Slider {
	constructor(sliderId, minText, maxText) {
		...
		minDiv.classList.add("foot"); minDiv.classList.add("min");
		maxDiv.classList.add("foot"); maxDiv.classList.add("max");
		midDiv.classList.add("foot"); midDiv.classList.add("mid");
